...
namespace Chapter10a.ViewModels
{
    /// <summary>
    ...
    public class ClipViewModel : ViewModelBase
    {
        ...
        private const string clipServiceUrl =
       "http://serverapps10.esri.com/ArcGIS/rest/services/SamplesNET/USA_Data_ClipTools/GPServer/ClipCounties";
        ...
        public ClipViewModel()
        {
            ...
            Messenger.Default.Register<Esri.ArcGISRuntime.Controls.MapView>(this, (mapView) =>
            {
                ...
                gpTask = new Geoprocessor(new Uri(clipServiceUrl));
